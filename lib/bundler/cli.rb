...
module Bundler
  class CLI < Thor
    ...
    method_option :license, :type => :string, :default => 'MIT', :aliases => '-l', :desc => "Choose the license for your library" 
    ...
    def gem(name)
      ...
      when 'MIT'
        template(File.join("newgem/licenses/MIT.txt.tt"),    File.join(target, "LICENSE.txt"),                         opts)
      when 'GPL'
        template(File.join("newgem/licenses/GPL.txt.tt"),    File.join(target, "COPYING.txt"),                         opts)
      end
